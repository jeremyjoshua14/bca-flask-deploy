...
# parameter path: peron_id
# request body: note => {"content": "ccccc"}
# response: {content: "...", person_id: "...", note_id: "...", person_id:}
...
# req body: {content: "ddsadasda"} note
def update(person_id, note_id, note):
    ...
    if found_note is None:
        abort(404, f"note with id {note_id} own by person {person_id} not found!")
